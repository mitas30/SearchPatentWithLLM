...
**SearchPatentWithLLM**は、ユーザのアイデアと近い特許が無いか簡単に調べることができる web アプリケーションです。<br>
このアプリは、従来の[特許調査サイト](https://www.j-platpat.inpit.go.jp/)を使う知識の無い全ての発明家のために作られました。<br>
ユーザは「どんな問題に対するアイデアか」、「アイデア名」、「アイデアに使う技術」、「どうやって問題を解決するか」の4項目を入力すると、自分のアイデアに近い特許が無いか調べることができます。
...
- **LLM による自動キーワード抽出**
  - LLMを使用して、特許文書とあなたのアイデアから 10 個のキーワードを自動的に抽出します。
...
- [PyMupdf](https://pymupdf.readthedocs.io/ja/latest/)
...
- [pinecone](https://docs.pinecone.io/reference/upsert)
